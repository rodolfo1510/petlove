...
<head>
  ...
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Denk One:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center">
          ...
          <!-- Uncomment below if you prefer to use an image logo -->
           <a href="" class="logo mr-auto"><img src="<?php echo base_url(); ?>assets/img/logo.png" alt=""></a>
           <h1 class=" mr-auto"><a href="">Petlove<span>.</span></a></h1>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="<?php echo base_url(); ?>assets/img/tabs-4.jpg" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
